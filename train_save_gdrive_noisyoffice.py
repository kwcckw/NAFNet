...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '-opt', type=str, default='options/train/SHABBY/shabby_x4.yml')
    parser.add_argument(
        '--launcher',
...
def main():
    ...
    # automatic resume ..
    state_folder_path = '/content/gdrive/MyDrive/ICDAR/Trained\ Models/NAFNet/NAFNet_noisyoffice_weights/current_run/experiments/{}/training_states/'.format(opt['name'])
    import os
    try:
